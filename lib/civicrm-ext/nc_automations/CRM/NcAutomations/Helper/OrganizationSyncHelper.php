...
class CRM_NcAutomations_Helper_OrganizationSyncHelper
{
     ...
     * @return void
     */
    public function invalidateInvestorAtRelationshipFromDeletedIndividual(string|int $contactId)
    {
     ...
     */
    public function syncOrganizationCustomFields(string|int $contactId): void
    {
        ...
        if (!$organizationId) {
            \Civi::log('SyncInvestorRepresentativesHelper')->warning("Could not find an associated organization from contact id $contactId");
            return;
        }
     ...
     *
     * @param int|string $representativeId
     * @return false|mixed
     */
    private function getOrganization(int|string $representativeId)
    {
...
// Get the results from the Api4\Generic\Result Class
    ...
    /**
     * Updates the aggregated fields of the organization using CiviCrm Api4
     *
     ...
     * @param string|int $contactId
     */
    public function restoreInvestorAtRelationshipFromDeletedIndividual(string|int $contactId): void
    {
        $id = intval($contactId);
