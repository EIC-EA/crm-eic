  ...
  [
    ...
    'params' => [
      ...
      'values' => [
        ...
        'extends' => 'Case',
        // Shared project-context group: shown on the Onboarding case and on every
        // Service Request case type so each SR carries the EIC project context.
        'extends_entity_column_value:name' => [
          'eic_awardee_onboarding',
          'eic_sr_venturematch',
          'eic_sr_coaching',
