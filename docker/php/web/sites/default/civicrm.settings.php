...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define('CIVICRM_UF_DSN', 'mysql://root:@mysql:3306/eic_crm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://root:@mysql:3306/eic_crm?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define('CIVICRM_UF_BASEURL', 'http://localhost:8080');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define('CIVICRM_SITE_KEY', '3N4MH3wuhhFtMYaZt0ZMnZ3QImKU81VY25jifdu5uEo');
}
...
if (!defined('CIVICRM_CRED_KEYS')) {
  define('_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:zzPObErGukL90OyPkS63AmnRbEdRpCCeG2lJPis7FBi5uvw');
...
if (!defined('CIVICRM_DEPLOY_ID')) {
  define('_CIVICRM_DEPLOY_ID', '6FS7X5AJyIdrcw');
...
if (!defined('CIVICRM_SIGN_KEYS')) {
  define('_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:uqIcmfvzpHXIGlm6JZxoPC4irCjChvIzpFRhLeagP8CuTIFnMoNpWg');
...
// define('CIVICRM_MAIL_LOG', '/opt/drupal/web/sites/default/files/civicrm/templates_c/mail.log');
// }
 ...
 * To use the filesystem                use a value of 'FileCache'
...
// Override the extensions assets URL
$civicrm_setting['domain']['extensionsURL'] = CIVICRM_UF_BASEURL . '/libraries/civicrm';
